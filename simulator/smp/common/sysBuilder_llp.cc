...
void SysBuilder_llp :: config_components()
{
   ...
   /*     if(proc_str == "ZESTO") m_proc_builder = new Zesto_builder(this);*/
        ...
        if(mem_str == "HMC")
        {
            ...
            int num_hmc_nodes = setting_hmc_xbar.getLength(); //number of HMC network nodes
...
void SysBuilder_llp :: dep_injection_for_mcp()
{
    ...
    } else if (m_mc_builder->get_type() == MemControllerBuilder::DRAMSIM) {
